...
(function () {
  ...
  function defaultData() {
    return {
      ...
      categories: [
        { id: uid(), name: "Salary", icon: "icons/category/banknote.png", type: "income" },
        { id: uid(), name: "Bonus", icon: "icons/category/gift.png", type: "income" },
        { id: uid(), name: "Profit", icon: "icons/category/trending-up.png", type: "income" },
        { id: uid(), name: "Freelance", icon: "icons/category/laptop-minimal.png", type: "income" },
        { id: uid(), name: "Other", icon: "icons/category/circle-ellipsis-1.png", type: "income" },
        { id: uid(), name: "Food", icon: "icons/category/fork-knife.png", type: "expense" },
        { id: uid(), name: "Transport", icon: "icons/category/bus-front.png", type: "expense" },
        { id: uid(), name: "Shopping", icon: "icons/category/shopping-bag.png", type: "expense" },
        { id: uid(), name: "Health", icon: "icons/category/heart-pulse.png", type: "expense" },
        { id: uid(), name: "Entertainment", icon: "icons/category/gamepad.png", type: "expense" },
        { id: uid(), name: "Bills", icon: "icons/category/receipt-text.png", type: "expense" },
        { id: uid(), name: "Sport", icon: "icons/category/dumbbell.png", type: "expense" },
        { id: uid(), name: "Car", icon: "icons/category/car.png", type: "expense" },
        { id: uid(), name: "Invest", icon: "icons/category/trending-up.png", type: "expense" },
        { id: uid(), name: "Job & Business", icon: "icons/category/briefcase.png", type: "expense" },
        { id: uid(), name: "Utilities", icon: "icons/category/zap.png", type: "expense" },
        { id: uid(), name: "Necessary", icon: "icons/category/house.png", type: "expense" },
        { id: uid(), name: "Give", icon: "icons/category/hand-heart.png", type: "expense" },
        { id: uid(), name: "Other", icon: "icons/category/circle-ellipsis.png", type: "expense" },
        { id: uid(), name: "Savings", icon: "icons/category/piggy-bank.png", type: "saving" },
        { id: uid(), name: "Transfer", icon: "icons/tx/transfer.png", type: "transfer" },
      ],
      pockets: [],
      pocketItems: [],
      transactions: [],
